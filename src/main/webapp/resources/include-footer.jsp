            ...
            <div class="col-lg-3 col-md-6">
                <div class="footer-widget">
                    ...
                    <div class="contact-info">
                        ...
                        <p><i class="fa fa-phone"> 0905999999</i></p>
                    </div>
                </div>
            </div>
...
<!-- Footer Bottom Start -->
<div class="footer-bottom" style="background: gray;">
    <div class="container" >
        <div class="row">
            <div class="col-md-6 copyright">
                <p>Copyright &copy; e-Commerce Team</p>
            </div>
            <div class="col-sm-3">
                <i class="fa fa-envelope"> e-CommerceTeam@gmail.com</i>
                
            </div>
            <div class="col-sm-3">
                <i class="fa fa-phone-alt"> 0905999999</i>

...
<div class="container">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <h2 class="text-center">Update Orders</h2>
                ...
                <div class="col-md-12">
                    ...
                    <form:form action="save" cssClass="form-horizontal" method="post" modelAttribute="ordersType">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-9">
                                <form:input path="cost" cssClass="form-control"  readonly="true"/>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-9">
                                <form:input path="discount" cssClass="form-control"  readonly="true"/>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-9">
                                <form:input path="total" cssClass="form-control"  readonly="true"/>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <label for="total" class="col-md-3 control-label" >CreateDate</label>
                            <div class="col-md-9">
                                <form:input path="createDate" cssClass="form-control"  readonly="true"/>
                            </div>
                        </div>

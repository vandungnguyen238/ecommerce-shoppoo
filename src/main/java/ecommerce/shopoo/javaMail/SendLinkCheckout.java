    ...
    public static void sendMailTo(String recepientMail, long id) throws Exception {
        ...
        try {
            ...
            String htmlCode = "<h1> Send message from java </h1> "
                    + "<h2>"
                    + "<a href='http://localhost:8080/e_Commerce_Shopoo/checkout/confirm?id=" + id + "'> "
                    + "Click into link to Confirm Place Order</a>"
                    + "</h2> ";                               
...
//            message.setContent(emailContent);
            ...
            System.out.println("Please Check Mail!");
        } catch (Exception e) {}
    }
}